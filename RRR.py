...
{M}[{W}●{M}]{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{M}[{W}●{M}]
      {W}[{M}≽{W}] {G2}Teligerm  {R}⊣ {W}https://t.me/ZERO_CYBER_TEM
...
def app():
    ...
    if key in link:
        ...
        if x in ['1','A']:os.system("xdg-open https://t.me/ZERO_CYBER_TEM");sleep(3);linex();exit()
...
def RAFAT():
    ...
    elif xpx in ['04','4']:os.system('xdg-open https://t.me/ZERO_CYBER_TEM');os.system('python X-RAFAT.py')
    else:RAFAT()
